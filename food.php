...
<div class="container" id="yiyecekler-details">
    <div class="geri_don">
        <a href="index.php">
            <div class="back-btn">
                <div class="icon-back">
            ...
            <div class="gall-col gallery-img-box gallery-bread">
                <a>
                    <div class="lrc-content">
                        <div class="lrc-img">
                            <img class="card-img-top" src="nedmin/dmg/foods/<?php echo $row['foods_file']; ?>" alt="<?php echo $row['foods_title']; ?>">
                        </div>
                        <div class="lrc-desc">
                            <div class="lrc-title">
                                <h2 class="card-title"><?php echo $row['foods_title']; ?></h2>
                            </div>
                            <div class="lrc-text">
                                <p class="card-text"><?php echo mb_substr($row['foods_content'], 0, 400) ?></p>
                            </div>
                            <div class="lrc-text">
                                <p class="card-text"><?php echo '₺' . mb_substr($row['foods_price'], 0, 400) ?></p>
                            </div>
